...
Explizit geht es um folgende zwei Algorithmen: Der Red-Clustering-Algorithmus mit einer bewiesenen Approximationsgüte von $\mathcal{O}(n^4)$ und dem Fast-Anchor-Algorithmus mit einer Approximationsgüte von $\mathcal{O}(n^3)$
