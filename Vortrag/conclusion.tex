...
\begin{frame}{Analyse der Ergebnisse - Güte}
    \begin{itemize}
        \item Überraschend: Fast-Anchor-Clustering schlechter?
...
\begin{frame}{Mögliche Verbesserungen}
    \begin{large}
        ...
        \item Laufzeit
        \begin{itemize}
            \item redundante Berechnungen reduzieren
...
\begin{frame}{Fazit}
    ...
    \end{large}
        \begin{itemize}
            \item längere Laufzeit
            \item größere Cluster
            \item größere Varianz
