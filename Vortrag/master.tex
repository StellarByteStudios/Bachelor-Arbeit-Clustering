...
\newcommand{\abschluss}{Bachelor/Master/Diplom}                              % HIER UNZUTREFFENDES LÖSCHEN
\title{\abschluss{}arbeit:\\TITEL DER ABSCHLUSSARBEIT}                      % HIER DEN TITEL DER ARBEIT EINTRAGEN
\author{VORNAME NAME}                                                       % HIER DEN NAMEN UND VORNAMEN EINTRAGEN
