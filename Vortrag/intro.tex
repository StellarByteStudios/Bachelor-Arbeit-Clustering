...
\begin{frame}{Auffrischer Clustering}
    ...
    \begin{minipage}[t]{0.35\textwidth}
        ...
        \includegraphics[height=\textheight*4/5]{fig/Gonzalez Beispiel/Clusterbeispiel Optimal.jpg}
    \end{minipage}
...
% Mehrere Fair-CLustering-Slides mit Bildern

\begin{frame}{Auffrischer fair Clustering}
    \begin{minipage}[t]{0.6\textwidth}
        \Copy{AuffrischungFair}{
            \begin{itemize}
                \item faires Attribut
                \item Zusatzbedingung: gleichmäßig Farben aufteilen auf Cluster
...
% Gonzalez in den Anhang geschoben
\iffalse
\begin{frame}{Auffrischer fair Clustering}
    \begin{minipage}[t]{0.6\textwidth}
        \Paste{AuffrischungFair}
...
\begin{frame}{Auffrischer fair Clustering}
    \begin{minipage}[t]{0.6\textwidth}
        \Paste{AuffrischungFair}
        % Unfaires Clustering mit Farben
        \includegraphics[width=\textwidth]{fig/Faires-Clustering Beispiel/Fair Beispiel unfair.jpg}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.35\textwidth}
        \vspace{-\baselineskip} % Move image to the top
...
\begin{frame}{Auffrischer fair Clustering}
    \begin{minipage}[t]{0.6\textwidth}
        \Paste{AuffrischungFair}
        % Unfaires Clustering mit Farben
        \includegraphics[width=\textwidth]{fig/Faires-Clustering Beispiel/Fair Beispiel fair.jpg}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.35\textwidth}
        \vspace{-\baselineskip} % Move image to the top
